...
import { TrendingDown, ExternalLink, Bookmark, BellRing, CheckCircle, AlertCircle, X, Star, Truck, ShoppingBag } from "lucide-react";
        ...
        <div className="col-span-5">
          <div className="relative bg-slate-50 rounded-xl overflow-hidden">
            {product.image
              ...
              : <div className="w-full h-72 bg-slate-100 flex items-center justify-center text-slate-400">No Image</div>
            }
            {product.drop > 0 && (

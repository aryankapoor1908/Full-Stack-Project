...
import { ThumbsUp, ExternalLink, Star, Truck, ImageOff } from "lucide-react";
...
export default function DealCard({ deal, onView }) {
  ...
  const hasValidImage = deal.image && !imgFailed;
        ...
        {hasValidImage
          ? (
            <img
              ...
              onError={() => setImgFailed(true)} // ← swap to inline placeholder, no extra request
            />
          )
          : <ImagePlaceholder />
        }
